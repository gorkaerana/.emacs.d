...
Code snippet from [[https://github.com/radian-software/straight.el?tab=readme-ov-file#getting-started][project readme]]. This is only used to fetch the catpuccin theme.
#+begin_src emacs-lisp
