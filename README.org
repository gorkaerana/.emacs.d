...
* Org Mode
Related reads:
- [[https://orgmode.org/worg/org-tutorials/orgtutorial_dto.html]["David O'Toole Org tutorial" by David O'Toole]]
- [[https://blog.aaronbieber.com/2016/09/24/an-agenda-for-life-with-org-mode.html]["An Agenda for Life With Org Mode" by Aaron Bieber]]
** Setup
#+begin_src emacs-lisp
(use-package org
  :ensure t
...
** Org roam
Related reads:
- [[https://systemcrafters.cc/build-a-second-brain-in-emacs/getting-started-with-org-roam/]["Build a Second Brain in Emacs Org Roam" by System Crafters]]
- [[https://www.orgroam.com/manual.html]["Org-roam User Manual" by Jethro Kuan]]

Following [[https://github.com/org-roam/org-roam/blob/e1873a6a1660b5c4f850df2da578d1a1b851f8ac/doc/installation.md#scoop][this]] installation guide:
#+begin_src emacs-lisp
...
* Python IDE packages
Related reads:
- [[https://realpython.com/emacs-the-best-python-editor/]["Emacs: The Best Python Editor? by John Fincher]]
